import firstProject from '../assets/images/first capstone.PNG';
...
import leaderboard from '../assets/images/leaderboad.PNG';
import shows from '../assets/images/Tv Maze.PNG';
...
const projects = [
  ...
  },
  {
    ...
    description: "This web app is for a company that offers space travel services. It's built with React and Redux, using spaceX API to get the data",
  ...
  },
  {
    ...
    description: 'This app makes use of an API and it displays a library of Tv Shows upon a search input. You can search for your favorite show or movie categories.',
    languages: ['HTML', 'CSS', 'JavaScript'],
