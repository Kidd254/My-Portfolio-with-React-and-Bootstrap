...
const ContactForm = () => (
  <div className="container-fluid d-flex flex-column justify-content-center align-items-center pt-5">
    <div className="row">
      <div className="col-md-3 offset-md-5 container-fluid">
    ...
    <form action="#" method="post">
      <div className="row mt-3 mb-3">
        <label htmlFor="nameInput" className="col-md-3 col-form-label">Name</label>
        <div className="col-md-8">
          <input id="nameInput" type="text" className="form-control" placeholder="Enter Your name" required />
        </div>
      </div>
      <div className="row mb-3">
        <label htmlFor="emailInput" className="col-md-3 col-form-label">Email</label>
        <div className="col-md-8">
      ...
      <div className="row mb-3">
        ...
        <label htmlFor="textInput" className="col-md-3 col-form-label">Message</label>
        <div className="col-md-8">
